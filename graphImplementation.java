...
public class graphImplementation{
    ...
    public static void main(String args[]){
        ...
        System.out.println(isForest(graph));
        // boolean ans = isForest(graph);
        // System.out.println(ans);
        // boolean[] vis = new boolean[n];
        // int gcc = getConnectedComponents(graph, vis);
        // System.out.println(gcc);
        // pair node = allSolutions(0, 6, 0, "0", vis, graph, new pair(), 50, 4);
        // System.out.println("Longest Weight = " + node.longestWeight);
        // System.out.println("Longest Path = " + node.longestPath);
        // System.out.println("Smallest Weight = " + node.smallestWeight);
        // System.out.println("Smallest Path = " + node.smallestPath);
        // justSmallerAndLarger("Just Larger Path than " + 30, node.ceil);
        // justSmallerAndLarger("Just Smaller Path than " + 30, node.floor);
        // System.out.println("4th longest path = " + pq.peek().path + " 4th longest Weight = " + pq.peek().weight);
    }
}
